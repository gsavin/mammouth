...
public class SelectServer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serversList = (RecyclerView) findViewById(R.id.servers_list);
        serversList.setHasFixedSize(true);

        mLayoutManager = new LinearLayoutManager(this);
        serversList.setLayoutManager(mLayoutManager);

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.add_server);
